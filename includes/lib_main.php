    ...
    if ($filename != 'index')
    {
        ...
        if (in_array($filename, array('category', 'goods', 'article_cat', 'article', 'brand')))
        {
            ...
            if (!empty($cat_arr))
            {
                ...
                foreach ($cat_arr AS $val)
                {
                    ...
                    $ur_here   .= ' <img src="themes/my/images/goods_28.png"/> <a href="' . build_uri($type, $args, $val['cat_name']) . '">' .
        ...
        else
        {
            ...
            if ('group_buy' == $filename)
            {
                ...
                $args       = array('gbid' => '0');
                $ur_here   .= ' <img src="themes/my/images/goods_28.png"/> <a href="group_buy.php">' .
            ...
            elseif ('auction' == $filename)
            {
                ...
                $args       = array('auid' => '0');
                $ur_here   .= ' <img src="themes/my/images/goods_28.png"/> <a href="auction.php">' .
            ...
            elseif ('wholesale' == $filename)
            {
                ...
                $args       = array('wsid' => '0');
                $ur_here   .= ' <img src="themes/my/images/goods_28.png"/> <a href="wholesale.php">' .
            ...
            elseif ('exchange' == $filename)
            {
                ...
                $args       = array('wsid' => '0');
                $ur_here   .= ' <img src="themes/my/images/goods_28.png"/> <a href="exchange.php">' .
...
function build_urhere($arr, $type = 'category')
{
    ...
    foreach ($arr AS $val)
    {
        ...
        $str .= ' <img src="themes/my/images/goods_28.png"/> <a href="' . build_uri($type, $args). '">' . htmlspecialchars($val['cat_name']) . '</a>';
    }
