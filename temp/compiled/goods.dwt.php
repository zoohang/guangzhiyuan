...
<div class="w1000 text">
  ...
  <div class="w210 goods_cat">
    <div class="cat_block">
      ...
      <ul class="cat_child">
      <?php $_from = $this->_var['best_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_08012800_1444895178');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_08012800_1444895178']):
?>
        <li class="cat_goods_tuijian">
          <a href="<?php echo $this->_var['goods_0_08012800_1444895178']['url']; ?>"><img src="<?php echo $this->_var['goods_0_08012800_1444895178']['thumb']; ?>" width="191px" height="146px" alt="" /></a>
          <p class="cat_goods_tuijian_title"><a href="<?php echo $this->_var['goods_0_08012800_1444895178']['url']; ?>"><?php echo $this->_var['goods_0_08012800_1444895178']['name']; ?></a></p>  
        </li>
...
?>
      ...
      <p class="goods_button">
        <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)"><img src="themes/my/images/goods_17.png" alt=""></a>
