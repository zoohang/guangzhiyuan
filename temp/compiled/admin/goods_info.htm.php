...
?>
        ...
        <table width="90%" id="mix-table" style="display:none" align="center">
          ...
          <tr>
            ...
            <td><input type="text" name="level" value="<?php echo $this->_var['goods']['level']; ?>" size="20" /></td>
          </tr>
          <tr>
            <td class="label">称号</td>
            <td><input type="text" name="designation" value="<?php echo $this->_var['goods']['designation']; ?>" size="20" /></td>
          </tr>
...
?>
  ...
  /**
   * éŽ¸å¤‹ç˜®æ¸šå¬­?ç» æ¤¾çŽ¯é
   * @param   string  inputName   æˆæ’³å†å¦—å——æ‚•ç»‰
   * @param   float   rate        å§£æ–¾ç·¥
   * @param   string  priceName   æµ é”‹ç‰¸æˆæ’³å†å¦—å——æ‚•ç»‰å¸®ç´™æ¿¡å‚›ç‰å¨Œâ„ƒæ¹é”›å±½å½‡shop_priceé”›
   */
  ...
  /**
   * ç’å‰§ç–†æµœå—•ç«´æ¶“?æ™¢éä½·çŽ¯éç¡·ç´é€ç‘°å½‰ç”¯å‚šæº€æµ é”‹ç‰¸éŠ†ä½ºÐé’å—•äº’é™å©ç´°é›æ¨¹çŽ¯é
   */
...
?>
  ...
  /**
   * éè§„åµç”¯å‚šæº€æµ é”‹ç‰¸é”›å²ƒ?ç» æ¥€è‹Ÿé€ç‘°å½‰éŸå——ç°µæµ é”‹ç‰¸éŠ†ä½ºÐé’å—•äº’é™å©ç´°é›æ¨¹çŽ¯é
   */
...
?>
  ...
  function handleSpec()
  {
      ...
      for (var i = 0; i < elementCount; i++)
      {
          ...
          if (element.id.substr(0, 5) == 'spec_')
          {
              ...
              hiddenSpec.value = value.join(String.fromCharCode(13)); // é¢ã„¥æ´–æžï¹‚æ•­é—…æ–¿ç´‘å§£å¿Žé‡œç‘™å‹¬ç‰¸
          }
      }
      return true;
  }
  ...
  */
  ...
  /**
   * éï¿ ç™æµ¼æ¨»å„¬éç‰ˆåµé„?æƒå§ï½‡â€˜
   */
