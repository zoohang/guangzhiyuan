...
<div class="tab-div">
  ...
  <div id="tabbody-div">
    ...
    <table width="90%" id="general-table">
      ...
      <tr>
        <td class="narrow-label">文章封面图片</td>
        <td><input type="file" name="article_img"><?php if ($this->_var['article']['article_img']): ?> <img src="images/yes.gif" border="0" /> <?php else: ?> <img src="images/no.gif" /> <?php endif; ?></td>
      </tr>
      <tr>
