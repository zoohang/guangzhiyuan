...
?>
      ...
      <tr>
        ...
        <td>
          <input type="file" name='cat_img' <?php if ($this->_var['cat_info']['cat_img']): ?> value='<?php echo $this->_var['cat_info']['cat_img']; ?>'<?php else: ?> value=""<?php endif; ?> size="15" />
          <?php if ($this->_var['cat_info']['cat_img']): ?> <img src="images/yes.gif" border="0" /> <?php else: ?> <img src="images/no.gif" /> <?php endif; ?>
        </td>
      </tr>
      <tr>
      ...
      <tr>
      <td colspan="2">
        <p style="padding: 10px;font-size: 16px;font-weight: blod;width: 128px;margin: auto;">分类详情描述：</p>
      </td>
      </tr>
      <tr>
      <td colspan="2">
        <div style="width:1000px;text-align: center;margin: auto;"><?php echo $this->_var['FCKeditor']; ?></div>
      </td>
      </tr>
      </table>
